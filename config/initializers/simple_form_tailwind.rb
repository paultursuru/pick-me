...
SimpleForm.setup do |config|
  ...
  config.wrappers :vertical_form, tag: 'div', class: 'm-0' do |b|
    b.use :html5
    b.use :placeholder
    ...
    b.use :full_error, wrap_with: { tag: 'p', class: 'm-0 text-red-500 text-xs italic' }
    b.use :hint, wrap_with: { tag: 'p', class: 'm-0 text-grey-700 text-xs italic' }
  end

  # vertical input for boolean (aka checkboxes)
  config.wrappers :vertical_boolean, tag: 'div', class: 'm-0 flex items-start', error_class: '' do |b|
    b.use :html5
    b.optional :readonly
    ...
    b.wrapper tag: 'div', class: 'm-0 text-sm' do |bb|
  ...
  config.wrappers :vertical_collection, item_wrapper_class: 'flex items-center justify-center', item_label_class: 'm-0 block text-sm font-medium text-gray-400', tag: 'div', class: 'm-0 w-full' do |b|
    b.use :html5
    b.optional :readonly
